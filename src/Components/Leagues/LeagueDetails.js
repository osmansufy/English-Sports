  ...
  return (
    <div>
      ...
      <Container maxWidth="md">
        <Grid
          style={{ backgroundColor: "#3A42FF", margin: "40px 0" }}
          container
          spacing={1}
        >
          <Grid className="leagueDetails" container item md={6}>
            ...
            <ul>
              ...
              <li>
                ...
                <span>Gender:{legueDetails.strGender}</span>
              </li>
            </ul>
          </Grid>
            ...
            <div className="img-container">
              {gender == "Male" ? (
                <img
                  ...
                  src={legueDetails?.strPoster}
                />
              ) : (
                <img
                  style={{ width: "100%", height: "100%" }}
                  src={legueDetails?.strFanart4}
                />
              )}
            </div>
          </Grid>
        </Grid>
        <p>{legueDetails?.strDescriptionEN}</p>
      </Container>

      <div className="social-log">
        <Link
          className="webIcon"
          to={{ pathname: `https://${legueDetails?.strWebsite}` }}
          target="_blank"
        >
        ...
        <Link
          to={{ pathname: `https://${legueDetails?.strYoutube}` }}
          target="_blank"
        >
